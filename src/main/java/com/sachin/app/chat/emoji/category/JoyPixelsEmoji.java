...
public class JoyPixelsEmoji extends Emoji {
    private static final int CACHE_SIZE = 100;
    private static final int SPRITE_SIZE = 64;
    //private static final int SPRITE_SIZE_INC_BORDER = 66;
    private static final int NUM_STRIPS = 67;
    ...
    public JoyPixelsEmoji(@NonNull final int[] codePoints, final int x, final int y, final boolean isDuplicate) {
    ...
    public JoyPixelsEmoji(final int codePoint, final int x, final int y, final boolean isDuplicate) {
    ...
    public Drawable getDrawable(final Context context) {
        ...
        final Bitmap cut = Bitmap.createBitmap(strip, 1, y * SPRITE_SIZE + 1, SPRITE_SIZE, SPRITE_SIZE);
